...
namespace Assignment6
{
    internal class AssignQ1
    {
        ...
        public class EmployeeManagementSystem : Iprintable
        {
            ...
            {
                public delegate void EmployeeDelegate(double PetrolAllowance, double FoodAllowance, double OtherAllowance);





                public void Calculate(double PetrolAllowance, double FoodAllowance, double OtherAllowance)
                {
            ...
            public class Q1
            {
                public static void Main()
                {
                    ...
                    EmployeeDelegate del_obj = new EmployeeDelegate(manager.Calculate);
